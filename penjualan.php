<?php
require_once 'functions/function_penjualan.php';
...
<head>
    ...
    <!-- Favicon icon -->
    <title>Penjualan | Inventori Barang</title>
    <!-- This page css -->
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Penjualan Barang</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php" class="text-muted"> Dashboard</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Penjualan Barang</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="card-title">Tabel Penjualan Barang</h4>
                                <h6 class="card-subtitle">Manage Penjualan Barang in the table below.</h6>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <td>
                                    <a href='edit_penjualan.php?idpenjualan={$penjualan['idpenjualan']}' class='btn btn-warning btn-sm'>Edit</a>
                                    <a href='process/process_penjualan.php?delete&idpenjualan={$penjualan['idpenjualan']}' class='btn btn-danger btn-sm'>Hapus</a>
                                </td>
                            </tr>";
                                    }
                                    ?>
                        ...
                        <div class="modal-body">
                            <form id="formTambahPenjualan">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="idcustomer" name="idcustomer" required>
                                </div>
                                <div class="mb-3">
                                    <label for="code" class="form-label">Kode Penjualan</label>
